  ...
  return (
    <div className="max-w-4xl mx-auto bg-white">
      ...
      <div className="flex justify-between items-center mb-8 p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white print:hidden">
        <h1 className="text-2xl font-bold">Gerador de PDF - Currículo</h1>
        <button
      ...
      <div id="resume-content" className="p-8 space-y-8">
        ...
        <section className="bg-blue-50 p-6 rounded-lg">
          ...
          <p className="text-gray-700 leading-relaxed">
            Atuar como operador de máquina, contribuindo para o crescimento da empresa e 
            alcançando desenvolvimento pessoal e profissional. Busco uma oportunidade onde 
            meus esforços e dedicação sejam reconhecidos.
          </p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">🧑‍🔧 Perfil Profissional</h3>
          </div>
          <div className="space-y-3 text-gray-700">
            <p>• Profissional com experiência no setor industrial e logístico, com facilidade em aprender novas funções.</p>
            <p>• Sou proativo, comunicativo, atento aos detalhes e tenho facilidade para trabalhar em equipe ou de forma independente.</p>
            <p>• Comprometido com a qualidade do serviço e sempre disposto a ajudar os colegas.</p>
          </div>
        </section>
            ...
            <div className="border-l-4 border-blue-600 pl-6 pb-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <div className="flex items-center gap-2 mb-4 text-gray-600">
                  ...
                  <span className="text-sm">📅 Desde 22/04/2024 (emprego atual)</span>
                </div>
                <ul className="space-y-2 text-gray-700">
                  <li>• Atividades voltadas à logística interna e organização de materiais</li>
                  <li>• Apoio ao setor de produção e controle de estoque</li>
                  <li>• Agilidade e atenção no manuseio de cargas e movimentação</li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-l-4 border-gray-400 pl-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>• Operação de máquinas específicas para tingimento de tecidos</li>
        ...
        <section className="bg-yellow-50 p-6 rounded-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">📘 Formação Complementar</h3>
          </div>
          <p className="text-gray-700">
            <strong>Curso de Operação de Empilhadeira</strong> – Motherson (2024)
          </p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">🛠️ Competências e Habilidades</h3>
          </div>
